...
namespace SimpleSAML\Component\Memcache;
...
class MemcacheServersGroup
{
     ...
     */
    private function addMemcacheServer($memcache, $server)
    {
     ...
     */
    private function loadMemcacheServerGroup(array $group)
    {
        ...
        $this->extension = strtolower($class);
        ...
        foreach ($group as $index => $server) {
            ...
            $this->addMemcacheServer($memcache, $server);
        }
    ...
    private function getMemcacheServers()
    {
        ...
        $groups = $this->configuration->getArray('memcache_store.servers');
        ...
        foreach ($groups as $index => $group) {
            ...
            $this->serverGroups[] = $this->loadMemcacheServerGroup($group);
        }
    ...
    private function getExpireTime()
    {
        ...
        $expire = $this->configuration->getInteger('memcache_store.expires', 0);
    ...
    public function getStats()
    {
        ...
        foreach ($this->getMemcacheServers() as $sg) {
